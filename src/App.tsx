				...
				<main>
					...
					<div className="project-container">
						...
						<div className="project">
							<div className="project-content">
								<div className="project-image">
									<img src="project/gon.png" alt="Gambar Project" />
								</div>
								<div className="project-details">
					...
					<section id="certificates">
						<div className="container" style={{ display: "flex", flexWrap: "wrap" }}>
							...
							<div className="certificate">
								<div className="certificate-image">
									<img src="sertifikat/dicoding_aws.png" className='certificate-image' alt="Gambar Sertifikat"/>
								</div>
							</div>
							<div className="certificate">
								<div className="certificate-image">
									<img src="sertifikat/dicoding_backend.png" className='certificate-image' alt="Gambar Sertifikat"/>
								</div>
							</div>
							<div className="certificate">
								<div className="certificate-image">
